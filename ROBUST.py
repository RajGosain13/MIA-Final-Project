...
# Apply watermark
WMimage, WM, used_coords, _ = w.embed_robust(image, user_id, alpha, block_size)
...
for name, attacked_image in attacked.items():
    watermark_extracted = w.extract_robust(image, attacked_image, used_coords, alpha, block_size)
